...
var Server = Emitter._extend({
  ...
  setup: function(callback) {
    ...
    this.agenda = new Agenda(this.config.get("agenda"));
    this.agenda.start();

    this.logger.info("setup agenda");
    ...
    var exceptRE = new RegExp("^" + http.join(this.staticRoot, "public") + ".*$");
    this.app.use(auth(userName, userPass, deadtime, exceptRE));
    ...
    this.app.use(this.staticRoot, less("static", this.lessConfig));
